        ...
        <section className="relative h-[95vh] min-h-[700px] flex items-center bg-slate-900 text-white overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col justify-center h-full">
                <div className="max-w-4xl opacity-0 animate-[fadeIn_1s_ease-out_forwards]">
                    <div className="inline-block px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6 animate-[slideDown_0.8s_ease-out_0.2s_forwards] opacity-0">
                        <span className="text-accent font-bold tracking-wider text-sm">LÍDERES EN CONSULTORÍA BIM</span>
                    </div>

                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold leading-[1.1] mb-8 tracking-tight animate-[slideUp_0.8s_ease-out_0.4s_forwards] opacity-0">
                    ...
                    <p className="text-xl md:text-2xl text-slate-300 mb-12 max-w-2xl leading-relaxed font-light animate-[slideUp_0.8s_ease-out_0.6s_forwards] opacity-0">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 animate-[slideUp_0.8s_ease-out_0.8s_forwards] opacity-0">
